...
- pin_list:
  ...
  - {pin_num: '24', peripheral: LPUART0, signal: TX, pin_signal: PTA2/LPUART0_TX/TPM2_CH1, direction: OUTPUT}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : BOARD_InitSens_luz
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
void BOARD_InitSens_luz(void)
{
    ...
    /* Initialize GPIO functionality on pin PTD5 (pin 62)  */
    GPIO_PinInit(BOARD_INITSENS_LUZ_LED1_GPIO, BOARD_INITSENS_LUZ_LED1_PIN, &LED1_config);
    ...
    /* Initialize GPIO functionality on pin PTE31 (pin 19)  */
    GPIO_PinInit(BOARD_INITSENS_LUZ_LED2_GPIO, BOARD_INITSENS_LUZ_LED2_PIN, &LED2_config);

    /* PORTA1 (pin 23) is configured as LPUART0_RX */
    PORT_SetPinMux(BOARD_INITSENS_LUZ_DEBUG_UART0_RX_PORT, BOARD_INITSENS_LUZ_DEBUG_UART0_RX_PIN, kPORT_MuxAlt2);

    /* PORTA2 (pin 24) is configured as LPUART0_TX */
    PORT_SetPinMux(BOARD_INITSENS_LUZ_DEBUG_UART0_TX_PORT, BOARD_INITSENS_LUZ_DEBUG_UART0_TX_PIN, kPORT_MuxAlt2);

    /* PORTD5 (pin 62) is configured as PTD5 */
    PORT_SetPinMux(BOARD_INITSENS_LUZ_LED1_PORT, BOARD_INITSENS_LUZ_LED1_PIN, kPORT_MuxAsGpio);

    /* PORTE22 (pin 11) is configured as ADC0_SE3 */
    PORT_SetPinMux(PORTE, 22U, kPORT_PinDisabledOrAnalog);

    /* PORTE31 (pin 19) is configured as PTE31 */
    PORT_SetPinMux(BOARD_INITSENS_LUZ_LED2_PORT, BOARD_INITSENS_LUZ_LED2_PIN, kPORT_MuxAsGpio);
