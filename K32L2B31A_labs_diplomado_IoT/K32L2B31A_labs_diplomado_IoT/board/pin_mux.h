...
/* Symbols to be used with GPIO driver */
#define BOARD_INITSENS_LUZ_LED1_FGPIO FGPIOD             /*!<@brief FGPIO peripheral base pointer */
#define BOARD_INITSENS_LUZ_LED1_GPIO GPIOD               /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITSENS_LUZ_LED1_GPIO_PIN_MASK (1U << 5U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_INITSENS_LUZ_LED1_PORT PORTD               /*!<@brief PORT peripheral base pointer */
#define BOARD_INITSENS_LUZ_LED1_PIN 5U                   /*!<@brief PORT pin number */
#define BOARD_INITSENS_LUZ_LED1_PIN_MASK (1U << 5U)      /*!<@brief PORT pin mask */
                                                         /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_INITSENS_LUZ_LED2_FGPIO FGPIOE              /*!<@brief FGPIO peripheral base pointer */
#define BOARD_INITSENS_LUZ_LED2_GPIO GPIOE                /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITSENS_LUZ_LED2_GPIO_PIN_MASK (1U << 31U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_INITSENS_LUZ_LED2_PORT PORTE                /*!<@brief PORT peripheral base pointer */
#define BOARD_INITSENS_LUZ_LED2_PIN 31U                   /*!<@brief PORT pin number */
#define BOARD_INITSENS_LUZ_LED2_PIN_MASK (1U << 31U)      /*!<@brief PORT pin mask */
                                                          /* @} */
...
/* Symbols to be used with PORT driver */
#define BOARD_INITSENS_LUZ_DEBUG_UART0_RX_PORT PORTA               /*!<@brief PORT peripheral base pointer */
#define BOARD_INITSENS_LUZ_DEBUG_UART0_RX_PIN 1U                   /*!<@brief PORT pin number */
#define BOARD_INITSENS_LUZ_DEBUG_UART0_RX_PIN_MASK (1U << 1U)      /*!<@brief PORT pin mask */
                                                                   /* @} */
...
/* Symbols to be used with PORT driver */
#define BOARD_INITSENS_LUZ_DEBUG_UART0_TX_PORT PORTA               /*!<@brief PORT peripheral base pointer */
#define BOARD_INITSENS_LUZ_DEBUG_UART0_TX_PIN 2U                   /*!<@brief PORT pin number */
#define BOARD_INITSENS_LUZ_DEBUG_UART0_TX_PIN_MASK (1U << 2U)      /*!<@brief PORT pin mask */
                                                                   /* @} */
